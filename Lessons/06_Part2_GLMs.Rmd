...
# Post-hoc test
# TukeyHSD() computes Tukey Honest Significant Differences, not all the means I am comparing are the same but r is grouping the data into similar clusters 
...
#one site and one category that is far from the rest 
```
