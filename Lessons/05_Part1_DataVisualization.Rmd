...
# How could you automatically assign a marker color to a variable? difine a different shape to differnt years 
PMplot <- 
...
#creating one plot for each of the sites. you can see teh separate sites and still see the circle and triangles and are still separted by month bc we wanted to see how they change throughout the year. 
