...
<<<<<<< HEAD
setwd("/Users/dianesanchez/Documents/Environmental Data Analytics/Environmental_Data_Analytics_2022/Lessons")
=======
...
```{r importdata}
<<<<<<< HEAD
read.csv("/Users/dianesanchez/Documents/Environmental Data Analytics/Environmental_Data_Analytics_2022/Data/Raw/USGS_Site02085000_Flow_Raw.csv")

# Relative file path (friendly for users regardless of machine)
getwd()
USGS.flow.data <- read.csv("./Data/Raw/USGS_Site02085000_Flow_Raw.csv", stringsAsFactors = TRUE) #../Data/Raw/USGS_Site02085000_Flow_Raw.csv"  
#if you are using relative paths you might need one or two dots. 
#stringsAsFactors = TRUE instead of imporitng as characters it would import as Factors. you need to make sure strings to be factors 
#
...
> Answer: they stay blank or are NA 
...
> Answer: you want to remove Na when you are dealing with a large data set and only want to work with data that is present. you would keep N/A when you want to show the amoutn of missing data? you would also remove NA when you want to work with compelte data 
