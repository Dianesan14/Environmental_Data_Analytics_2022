...
#craeting colum nutrient and whatever the nutrient is thhey will be in this cloumn and next to is there will be be concentraition our gathered data set is larger than the other data set 

NTL.nutrient.data.PeterPaul.gathered <- subset(NTL.nutrient.data.PeterPaul.gathered, !is.na(concentration))
count(NTL.nutrient.data.PeterPaul.gathered, nutrient)#if you specify a colum or category you can select this format to get the data 
