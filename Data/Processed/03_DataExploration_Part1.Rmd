...
setwd("/Users/dianesanchez/Documents/Environmental Data Analytics/Environmental_Data_Analytics_2022")
```
...
> Answer: The data started to download but then they all went away 
...
# Write Code for three differnt date formats 
# An example is 
...
write.csv(USGS.flow.data, file = "/Users/dianesanchez/Documents/Environmental Data Analytics/Environmental_Data_Analytics_2022/Data/Processed/USGS_Site02085000_Flow_Processed.csv", row.names=FALSE)
