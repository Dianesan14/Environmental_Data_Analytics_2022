...
student_test_score <- data.frame(student, Score, passed_test)
  
```

9. QUESTION: How is this data frame different from a matrix?

> Answer: A data frame allows for multiple forms of data to be analyzed on a table while a matrix is used to analyze same type of data. 
...
# ( student_test_score) <- function( x ) {ifelse x >= 50,  print(TRUE), print(FALSE)}
...
>  Answer: ifelse worked becuase there 
